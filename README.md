# 🖥️ Open Source Audit Project

## 👩‍🎓 Student Details
- **Name:** Anushka Patidar  
- **Registration Number:** 24BCE11382  
...
## 📌 Project Overview
This project analyzes an open-source software (Apache HTTP Server).  
It focuses on understanding licensing, Linux usage, and practical shell scripting.
